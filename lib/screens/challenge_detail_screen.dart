...
class _ChallengeDetailScreenState extends State<ChallengeDetailScreen>
  ...
  Future<void> _startChallenge() async {
    final result = await SigmaConfirmationDialog.show(
      ...
      message:
          'Are you ready to start the "${_challenge.title}" challenge? This requires daily commitment for ${_challenge.duration} days.',
      confirmText: 'START',
      cancelText: 'NOT YET',
        ...
        try {
          ...
          if (context.mounted) {
            ...
            final updatedChallenge =
                challenges.firstWhere((c) => c.id == _challenge.id);
            setState(() {
                ...
                children: [
                  ...
                  if (_challenge.isActive || _challenge.isCompleted) ...[
                    ...
                    DisciplineTracker(
                      ...
                      onCheckIn: _challenge.isActive &&
                              !_challenge.isCompleted &&
                              _challenge.canCheckInToday()
                          ? _checkInChallenge
                          : null,
                    ),
                    const SizedBox(height: 24),
                  ...
                  if (!_challenge.isActive && !_challenge.isCompleted)
                    ...
                    SizedBox(
                      width: double.infinity,
                      child: ElevatedButton.icon(
                        onPressed: _challenge.canCheckInToday()
                            ? _checkInChallenge
                            : null,
            ...
            child: Column(
              children: [
                ...
                if (_challenge.isCompleted &&
                    _challenge.completionDate != null) ...[
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      const Icon(
